...
for i in range(number):
    start = input("Enter location of person " + str(i+1) + ": ")
    temp = Dijkstra(start)
    trial.append(temp)
...
print("Best place to meet up: " + mrt_names[optimals[0][1]])
print("Alternative place to meet up: " + mrt_names[optimals[1][1]])
print("Another alternative place to meet up: " + mrt_names[optimals[2][1]])
